...
public class AddItemFragment extends Fragment {
    ...
    private void addItem() throws FileNotFoundException {
        ...
        if (selectedImage != null){
            ContentResolver cR = FantApplication.getAppContext().getContentResolver();
            multiPartForm
                    .addPart("title", title.getText().toString())
                    .addPart("desc", description.getText().toString())
                    .addPart("price", price.getText().toString())
                    .addPart(
                    "image",
